...
import com.ang.mov.activities.PersonDetailActivity;
...
public class MovieCastsAdapter extends RecyclerView.Adapter<MovieCastsAdapter.CastViewHolder> {
    ...
    public MovieCastsAdapter(Context mContext, List<MovieCastBrief> mCasts, InterstitialAd interstitialAd) {
