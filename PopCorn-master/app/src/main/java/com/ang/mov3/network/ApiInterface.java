package com.ang.mov3.network;

import com.ang.mov3.network.movies.Movie;
import com.ang.mov3.network.movies.MovieCastsOfPersonResponse;
import com.ang.mov3.network.movies.MovieCreditsResponse;
import com.ang.mov3.network.movies.NowShowingMoviesResponse;
import com.ang.mov3.network.movies.PopularMoviesResponse;
import com.ang.mov3.network.movies.SimilarMoviesResponse;
import com.ang.mov3.network.movies.TopRatedMoviesResponse;
import com.ang.mov3.network.movies.UpcomingMoviesResponse;
import com.ang.mov3.network.people.Person;
...
import com.ang.mov3.network.tvshows.SimilarTVShowsResponse;
import com.ang.mov3.network.tvshows.TVCastsOfPersonResponse;
import com.ang.mov3.network.tvshows.TVShow;
import com.ang.mov3.network.tvshows.TVShowCreditsResponse;
import com.ang.mov3.network.tvshows.TopRatedTVShowsResponse;
import com.ang.mov3.network.videos.VideosResponse;
...
public interface ApiInterface {
    ...
    Call<com.ang.mov3.network.movies.GenresList> getMovieGenresList(@Query("api_key") String apiKey);
    ...
    @GET("genre/tv/list")
    Call<com.ang.mov3.network.tvshows.GenresList> getTVShowGenresList(@Query("api_key") String apiKey);
